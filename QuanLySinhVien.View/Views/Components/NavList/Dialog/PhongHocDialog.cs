...
public class PhongHocDialog : CustomDialog
{
    ...
    public PhongHocDialog(string title, DialogType dialogType) : base(title, dialogType, 400, 450)
    {
        ...
        if (_dialogType == DialogType.ChiTiet) SetReadOnly();
    }
    ...
    private void InitializePhongHocControls()
    {
        ...
        _textBoxsContainer.Controls.Add(
            new Label { Text = "Tên phòng:", Anchor = AnchorStyles.Left, Dock = DockStyle.Fill }, 0, 0);
        _textBoxsContainer.Controls.Add(TxtTenPH, 1, 0);
        _textBoxsContainer.Controls.Add(
            new Label { Text = "Loại phòng:", Anchor = AnchorStyles.Left, Dock = DockStyle.Fill }, 0, 1);
        _textBoxsContainer.Controls.Add(TxtLoaiPH, 1, 1);
        _textBoxsContainer.Controls.Add(
            new Label { Text = "Cơ sở:", Anchor = AnchorStyles.Left, Dock = DockStyle.Fill }, 0, 2);
        _textBoxsContainer.Controls.Add(TxtCoSo, 1, 2);
        _textBoxsContainer.Controls.Add(
            new Label { Text = "Sức chứa:", Anchor = AnchorStyles.Left, Dock = DockStyle.Fill }, 0, 3);
