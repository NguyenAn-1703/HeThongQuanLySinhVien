...
-- ------------------------INSERT-----------------------------------
-- 1 - SINH VIÊN CHUẨN HÓA THEO LỚP MỚI
...
-- Hệ thống thông tin K21 (MaLop 1-3)
(1, 1, 2, 'Nguyen Van A', '0901111222', '2004-01-15', 'Hà Nội', 'Đang học', 'Nam', 'vana@gmail.com', '123456789012', 'a.jpg'),
(1, 1, 2, 'Tran Thi B', '0902222333', '2004-05-22', 'Đà Nẵng', 'Đang học', 'Nữ', 'thib@gmail.com', '987654321098', 'b.jpg'),
(1, 2, 2, 'Le Van C', '0903333444', '2004-03-10', 'HCM', 'Đang học', 'Nam', 'vanc@gmail.com', '456789123456', 'c.jpg'),
(1, 2, 2, 'Pham Thi D', '0904444555', '2004-07-12', 'Hải Phòng', 'Đang học', 'Nữ', 'thid@gmail.com', '111222333444', 'd.jpg'),
(1, 3, 2, 'Hoang Van E', '0905555666', '2003-09-05', 'Cần Thơ', 'Đang học', 'Nam', 'vane@gmail.com', '222333444555', 'e.jpg'),

-- Mạng máy tính K21 (MaLop 7-8)
(1, 7, 2, 'Hoang Thi F', '0906666777', '2004-11-19', 'Huế', 'Đang học', 'Nữ', 'thif@gmail.com', '333444555666', 'f.jpg'),
(1, 8, 2, 'Tran Van G', '0907777888', '2004-04-02', 'Quảng Ninh', 'Đang học', 'Nam', 'vang@gmail.com', '444555666777', 'g.jpg'),

-- Trí tuệ nhân tạo K21 (MaLop 11)
(1, 11, 2, 'Le Thi H', '0908888999', '2005-08-14', 'Bình Dương', 'Đang học', 'Nữ', 'thih@gmail.com', '555666777888', 'h.jpg'),

-- Khoa học dữ liệu K21 (MaLop 15)
(1, 15, 2, 'Pham Van I', '0909999000', '2003-12-25', 'Hà Nam', 'Đang học', 'Nam', 'vani@gmail.com', '666777888999', 'i.jpg'),

-- An toàn thông tin K21 (MaLop 17)
(1, 17, 2, 'Vu Thi J', '0910000111', '2005-06-07', 'Thanh Hóa', 'Đang học', 'Nữ', 'thij@gmail.com', '777888999000', 'j.jpg'),

-- Tài chính K21 (MaLop 19-20)
(1, 19, 2, 'Ngo Van K', '0911111222', '2004-10-11', 'Nghệ An', 'Đang học', 'Nam', 'vank@gmail.com', '888999000111', 'k.jpg'),
(1, 20, 2, 'Dang Thi L', '0912222333', '2004-01-20', 'Bắc Giang', 'Đang học', 'Nữ', 'thil@gmail.com', '999000111222', 'l.jpg'),

-- Kế toán K21 (MaLop 21)
(1, 21, 2, 'Nguyen Van M', '0913333444', '2005-02-16', 'Hà Tĩnh', 'Đang học', 'Nam', 'vanm@gmail.com', '123123123123', 'm.jpg'),

-- Quản trị kinh doanh K21 (MaLop 23)
(1, 23, 2, 'Pham Thi N', '0914444555', '2004-07-30', 'Thái Bình', 'Đang học', 'Nữ', 'thin@gmail.com', '234234234234', 'n.jpg'),

-- Kinh tế quốc tế K21 (MaLop 25)
(1, 25, 2, 'Tran Van O', '0915555666', '2003-03-18', 'Quảng Ngãi', 'Đang học', 'Nam', 'vano@gmail.com', '345345345345', 'o.jpg'),

-- Ngân hàng K21 (MaLop 27)
(1, 27, 2, 'Le Thi P', '0916666777', '2004-09-09', 'Kon Tum', 'Đang học', 'Nữ', 'thip@gmail.com', '456456456456', 'p.jpg'),

-- Hệ thống thông tin K22 (MaLop 4-5)
(1, 4, 3, 'Nguyen Van Q', '0917777888', '2005-05-21', 'Bạc Liêu', 'Đang học', 'Nam', 'vanq@gmail.com', '567567567567', 'q.jpg'),
(1, 5, 3, 'Hoang Thi Rg', '0918888999', '2004-08-13', 'Sóc Trăng', 'Đang học', 'Nữ', 'thir@gmail.com', '678678678678', 'r.jpg'),

-- Mạng máy tính K22 (MaLop 9)
(1, 9, 3, 'Pham Van S', '0919999000', '2003-11-02', 'Gia Lai', 'Đang học', 'Nam', 'vans@gmail.com', '789789789789', 's.jpg'),

-- Trí tuệ nhân tạo K22 (MaLop 12)
(1, 12, 3, 'Vu Thi Tuyet', '0920000111', '2005-12-01', 'Vĩnh Long', 'Đang học', 'Nữ', 'thit@gmail.com', '890890890890', 't.jpg'),

-- Khoa học dữ liệu K22 (MaLop 16)
(1, 16, 3, 'Ngo Van U', '0921111222', '2004-06-06', 'Trà Vinh', 'Đang học', 'Nam', 'vanu@gmail.com', '901901901901', 'u.jpg'),

-- Tài chính K22 (MaLop 22)
(1, 22, 3, 'Dang Thi X', '0922222333', '2005-02-27', 'Tây Ninh', 'Đang học', 'Nữ', 'thiv@gmail.com', '112112112112', 'v.jpg'),

-- Kế toán K22 (MaLop 24)
(1, 24, 3, 'Nguyen Van X', '0923333444', '2004-04-23', 'Lâm Đồng', 'Đang học', 'Nam', 'vanx@gmail.com', '223223223223', 'x.jpg');

-- 2 - LOP CHUẨN HÓA THEO THIẾT KẾ MỚI
INSERT INTO Lop (MaGV, MaNganh, TenLop, SoLuongSV) VALUES
-- Hệ thống thông tin (MaNganh = 1)
(1, 1, 'HTTT01-K21', 45),    -- K21 (2021-2025)
(2, 1, 'HTTT02-K21', 42),
(3, 1, 'HTTT03-K21', 40),
(4, 1, 'HTTT01-K22', 48),    -- K22 (2022-2026)
(5, 1, 'HTTT02-K22', 46),
(6, 1, 'HTTT01-K23', 50),    -- K23 (2023-2027)

-- Mạng máy tính (MaNganh = 2)
(7, 2, 'MMT01-K21', 38),
(8, 2, 'MMT02-K21', 35),
(9, 2, 'MMT01-K22', 40),
(10, 2, 'MMT01-K23', 42),

-- Trí tuệ nhân tạo (MaNganh = 3)
(1, 3, 'TTNT01-K21', 30),
(2, 3, 'TTNT01-K22', 32),
(3, 3, 'TTNT01-K23', 35),

-- Khoa học dữ liệu (MaNganh = 4)
(4, 4, 'KHMT01-K21', 28),
(5, 4, 'KHMT01-K22', 30),

-- An toàn thông tin (MaNganh = 5)
(6, 5, 'ATTT01-K21', 25),
(7, 5, 'ATTT01-K22', 27),
...
-- Quản trị kinh doanh (MaNganh = 8)
(3, 8, 'QTKD01-K21', 40),
(4, 8, 'QTKD01-K22', 42),

-- Kinh tế quốc tế (MaNganh = 9)
(5, 9, 'KTQT01-K21', 35),
(6, 9, 'KTQT01-K22', 38),

-- Ngân hàng (MaNganh = 10)
(7, 10, 'NH01-K21', 30),
(8, 10, 'NH01-K22', 32);

-- 3 - GIẢNG VIÊN CHO CÁC LỚP MỚI
INSERT INTO GiangVien (MaTK, MaKhoa, TenGV, SoDienThoai, Email) VALUES
-- Giảng viên CNTT
(1, 1, 'ThS. Nguyễn Văn Alpha', '0912345601', 'alpha@univ.edu.vn'),
(1, 1, 'TS. Trần Thị Beta', '0912345602', 'beta@univ.edu.vn'),
(1, 1, 'ThS. Lê Quang Gamma', '0912345603', 'gamma@univ.edu.vn'),
(1, 1, 'TS. Phạm Minh Delta', '0912345604', 'delta@univ.edu.vn'),
(1, 1, 'ThS. Đỗ Thị Epsilon', '0912345605', 'epsilon@univ.edu.vn'),
(1, 1, 'TS. Ngô Văn Zeta', '0912345606', 'zeta@univ.edu.vn'),
(1, 1, 'ThS. Vũ Thị Eta', '0912345607', 'eta@univ.edu.vn'),
(1, 1, 'TS. Bùi Anh Theta', '0912345608', 'theta@univ.edu.vn'),
(1, 1, 'ThS. Hoàng Lan Iota', '0912345609', 'iota@univ.edu.vn'),
(1, 1, 'TS. Phan Văn Kappa', '0912345610', 'kappa@univ.edu.vn'),

-- Giảng viên Kinh tế
(1, 2, 'ThS. Nguyễn Thị Lambda', '0912345611', 'lambda@univ.edu.vn'),
(1, 2, 'TS. Trần Văn Mu', '0912345612', 'mu@univ.edu.vn'),
(1, 2, 'ThS. Lê Thị Nu', '0912345613', 'nu@univ.edu.vn'),
(1, 2, 'TS. Phạm Văn Xi', '0912345614', 'xi@univ.edu.vn'),
(1, 2, 'ThS. Đỗ Thị Omikron', '0912345615', 'omikron@univ.edu.vn'),
(1, 2, 'TS. Ngô Văn Pi', '0912345616', 'pi@univ.edu.vn'),
(1, 2, 'ThS. Vũ Thị Rho', '0912345617', 'rho@univ.edu.vn'),
(1, 2, 'TS. Bùi Anh Sigma', '0912345618', 'sigma@univ.edu.vn');
