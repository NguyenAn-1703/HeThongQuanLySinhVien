...
public class NhomQuyenDao
{
    ...
    {
        if (_instance == null) _instance = new NhomQuyenDao();
    ...
    public bool Insert(NhomQuyenDto nhomQuyen)
    {
        var rowAffected = 0;
        using var conn = MyConnection.GetConnection();
        var query = @"INSERT INTO nhomquyen (TenNhomQuyen)
                         VALUES (@TenNhomQuyen)";
    ...
    public int GetLastAutoIncrement()
    {
        ...
        var query = "SELECT MAX(MaNQ) FROM nhomquyen";
