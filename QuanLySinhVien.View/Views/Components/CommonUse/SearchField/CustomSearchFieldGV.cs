...
namespace QuanLySinhVien.View.Views.Components.CommonUse.GiangVien;

public class CustomSearchFieldGV : CustomTextBox
{
    private readonly CustomPopup _popup;

    private readonly List<GiangVienDto> listHP;
    ...
    {
        //chọn trong list
        if (e.KeyCode == Keys.Down && !contentTextBox.Text.Equals("") && _popup.Visible) _popup._dt.Focus();

        //chọn trực tiếp
        if (e.KeyCode == Keys.Enter && !contentTextBox.Text.Equals("") && _popup.Visible)
