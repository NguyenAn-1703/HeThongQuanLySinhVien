...
public class SinhVienDAO
{
    ...
    public int CountSinhVienByStatus(TrangThaiSV status)
    {
        ...
        using var cmd = new MySqlCommand(sql, conn);
        var statusStr = TrangThaiSVHelper.ToDbString(status);
    ...
    public Dictionary<string, int> GetSinhVienCountByKhoaHoc()
    {
        ...
        while (reader.Read())
        {
            var tenKhoaHoc = reader.GetString("TenKhoaHoc");
    ...
    public Dictionary<string, float> TyLeSinhVienTotNghiepTheoNganh(bool IsDesc = true)
    {
        ...
        try
        {
            ...
            while (reader.Read())
            {
                var tenNganh = reader.GetString("TenNganh");
                var tongSoSinhVien = reader.GetInt32("TongSoSinhVien");
                var soLuongTotNghiep = reader.GetInt32("SoLuongTotNghiep");

                var tyLeTotNghiep = tongSoSinhVien == 0
                    ? 0
    ...
    public Dictionary<string, double> SoLuongSinhVienTheoNamNhapHoc()
    {
        ...
        try
        {
            ...
            while (reader.Read())
            {
                var namNhapHoc = reader.GetString("NamNhapHoc");
