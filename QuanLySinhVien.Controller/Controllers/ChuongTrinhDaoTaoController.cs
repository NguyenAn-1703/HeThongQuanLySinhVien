...
public class ChuongTrinhDaoTaoController
{
    ...
    private readonly List<ChuongTrinhDaoTaoDto> _listChuongTrinh;
    ...
    {
        if (_instance == null) _instance = new ChuongTrinhDaoTaoController();
        return _instance;
    }
    ...
    public bool ValidateNganhChuKy(int maNganh, int maChuKy)
    {
        ...
        var isDuplicate = _listChuongTrinh.Any(ct =>
            ct.MaNganh == maNganh &&
            ct.MaCKDT == maChuKy);
